...
update: (output,domEl) ->
  ...
  switch
    ...
    when ((osVersion.substr(0,5) == "10.15") && (theme == 'dark')) then (document.getElementById("osIcon").src = "os_version_pro.widget/icons/Catilina_dark.png") && (osRelease = ' Catilina')
    when osVersion.substr(0,5) == "10.15" then (document.getElementById("osIcon").src = "os_version_pro.widget/icons/Catilina.png") && (osRelease = ' Catilina')
